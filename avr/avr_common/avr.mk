...
AVRDUDE_FLAGS += -D -q -V -C /etc/avrdude.conf	#/usr/share/arduino/hardware/tools/avr/../avrdude.conf
# se ti da errori togli quel commento, il file avrdude.conf nel mio pc si trovava in un cartella diversa
...
%.elf:	%.o $(OBJS)
	$(CC) $(CC_OPTS) -o $@ $< $(OBJS) $(LIBS) $(CROSS_PLATFROM)
